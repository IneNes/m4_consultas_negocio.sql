...
GROUP BY MONTH(fecha_venta);
-- HALLAZGOS
-- 1. El producto 1 fue el que más facturó, con un total de $3600.
-- 2. El producto 2 fue el que más unidades vendió, con 13 unidades.
-- 3. Los 5 clientes realizaron 2 pedidos cada uno, por lo que todos son clientes recurrentes.